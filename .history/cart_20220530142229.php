...
<?php 
                         ...
                         case "submit":
                            ...
                            elseif (isset($_POST['update_checkout'])){
                                ...
                                if ($error == false && !empty($_POST['soluong'])) {
                                    ...
                                    $momo = "Giao dịch thanh toán bang MOMO thành công";
                                    unset($_SESSION['cart']);
                                }
                ...
                $insert_vnpay = "INSERT INTO tbl_momo(partner_code,order_id,amount,order_info,order_type,trans_id,pay_type)
                VALUE ('".$partnerCode."','".$orderID."','".$amount."','".$orderInfo."','".$orderType."','".$trans_id."','".$payType."')";
                $cart_query = mysqli_query($links,$insert_vnpay);
                }
            ?>  
<!DOCTYPE html>
<html lang="en">

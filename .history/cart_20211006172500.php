                         ...
                         case "submit":
                            ...
                            elseif (isset($_POST['update_checkout'])){
                                ...
                                if ($error == false && !empty($_POST['soluong'])) {
                                    ...
                                    $insertCus = mysqli_query($links, "INSERT INTO customer(cusID,name,address,tel) VALUE ('',$name,$address.$village.$district.$city,$tel)");
                                    $insertOrder = mysqli_query($links, "INSERT INTO orderinf() VALUES (NULL, '" . $_POST['name'] . "', '" . $_POST['phone'] . "', '" . $_POST['address'] . "', '" . $_POST['note'] . "', '" . $total . "', '" . time() . "', '" . time() . "');");

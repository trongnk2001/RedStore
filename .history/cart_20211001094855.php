        ...
        <div class="small-container cart-page">
            ...
            <div class="row" style="align-items: initial;">
                ...
                <div class="col-2 inf">
                    ...
                    <input class="dathang" type="submit" value="Đặt hàng &#8594" style="display: inline-block;background: #ff523b;color: #fff;padding: 8px 30px;margin: 30px 0;border-radius: 30px;transition: background 0.5s;border: none;cursor: pointer;height:32px;width:131px ;">

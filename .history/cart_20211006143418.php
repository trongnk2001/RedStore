            ...
            <div class="small-container" style="padding:0px 0px">
                ...
                <div class="row" style="align-items: initial;">
                    ...
                    <div class="col-2 inf" style="display: flex;align-items: center;flex-direction: column;">
                        ...
                        <input  type="submit" name="update_checkout" onclick="return validateForm()" value="Đặt hàng &#8594" style="display: inline-block;background: #ff523b;color: #fff;padding: 8px 30px;margin: 30px 0;border-radius: 30px;transition: background 0.5s;border: none;cursor: pointer;height:32px;width:131px ;">
                        </div>
                    </div>
                </div>  
            </div>

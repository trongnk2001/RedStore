...
<body>
    ...
    <form class="cod" action="cart.php?action=submit"  method="post">
        <!-- cart items details -->
        <div class="small-container cart-page">
                ...
                <div class="row" style="align-items: initial;">
                    <div class="col-2 inf" style="display: flex;align-items: center;flex-direction: column;">
                        ...
                        <div class="col-2 inf" style="display: flex;align-items: center;flex-direction: column;">
                            ...
                            <input  type="submit" name="thanhtoan_momo" value="Thanh toán MOMO &#8594" style="display: inline-block;background: #ff523b;color: #fff;padding: 8px 30px;margin: 30px 0;border-radius: 30px;transition: background 0.5s;border: none;cursor: pointer;height:32px;width:auto;">
                            </div>
                        </div>
                    </div>  
                </div>
            ...
            <form 
            class="momo" method="POST" target="_blank" enctype="application/x-www-form-urlencoded"

...
{
	$sql_query="DELETE FROM product WHERE productID=".$_GET['delete_id'];
            ...
            <div class="left_col scroll-view">
                ...
                <div class="menu_section">
                    ...
                    <li><a><i class="fa fa-edit"></i> Quản lí <span class="fa fa-chevron-down"></span></a>
                        ...
                        <li><a href="orderdetails.php">Quản lí phụ kiện</a></li>
                        </ul>
                    </li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                          ...
                          while($row=mysqli_fetch_row($result_set))
                          {
                              ?>
                                  <tr>
                                      ...
                                      <th style="text-align:center"><?php echo '<img style="width:50%" src="'.$row[3].'">'; ?></th>
	            ...
	            ?>
                    <tr>
                      <th colspan="8" style="text-align:center"><button type="submit" class="btn btn-success" name="btn-add"><a href="add-product.php" style="color:#fff">THÊM MỚI</a></button></th>
                    </tr>
                    </table>

...
{
	$sql_query="SELECT * FROM typepro WHERE id =".$_GET['edit_id'];
...
if(isset($_POST['btn-update']))
{
	...
	$sql_query = "UPDATE typepro SET id='$idloaisanpham',name='$ten',soluong='$soluong'
                                    ...
                                    <form class="" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional' name="idloaisanpham" data-validate-length-range="5,15" type="text" value="<?php echo $fetched_row['id']; ?>"/></div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional' name="quantity" data-validate-length-range="5,15" type="text" value="<?php echo $fetched_row['soluong']; ?>"/></div>
                                        </div>

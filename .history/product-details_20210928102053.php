                ...
                <div class="col-2">
                    <form action="">
                        ...
                        <select name="" id="">
                            ...
                            <input type="number" value ="1" name="sl" style="display:inline-block">

                        <input type="button"> <a href="cart.php?productID=<?php echo $row[0]?>" class="btn" name="themgiohang" style="display:inline">Thêm vào giỏ hàng  </a>

    ...
    <form class="cod" action="cart.php?action=submit"  method="post" style="display: block">
        ...
        <div class="small-container cart-page">
                ...
                <div class="row" style="align-items: initial;">
                    <div class="col-2 inf" style="display: flex;align-items: center;flex-direction: column;">
                        ...
                        <div class="col-2 inf" style="display: flex;align-items: center;flex-direction: column;">
                            ...
                            <input type="submit" onclick=""myFunction() value="THANH TOÁN MOMO">
                            </div>
                        </div>
                    </div>  
                </div>
            ...
            class="momo" method="POST" target="_blank" enctype="application/x-www-form-urlencoded"
                          action="xulithanhtoanmomo_atm.php?action=<?php echo $name?>" style="display:none">
                <input type="hidden" value="<?php echo number_format($total)?>" name ="total">
                <div id="momo" class="small-container" style="padding:0px 0px">
                ...
                <div class="row" style="align-items: initial;">
                    <div class="col-2 inf" style="display: flex;align-items: center;flex-direction: column;">
                        ...
                        <div class="col-2 inf" style="display: flex;align-items: center;flex-direction: column;">
                            ...
                            <button onclick="myFunction()">Thanh toán MOMO</button>    
                        </div>
                        </div>
                    </div>  
                </div>

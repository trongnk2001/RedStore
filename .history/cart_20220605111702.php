                         ...
                         case "submit":
                            ...
                            elseif (isset($_POST['update_checkout'])){
                                ...
                                if ($error == false && !empty($_POST['soluong'])) {
                                    ...
                                    for($i = 0; $i < count($array_cart[0]); $i++){
                                        echo '<pre>';
                                        var_dump($array_cart[0][$i]['id']);
                                        echo '</pre>';
                                    

                                    $products = mysqli_query($links, "SELECT * FROM product WHERE productID = echo $array_cart[0][$i]['id']");
                                    $total = 0;
                                    $orderProducts = array();
                                    ...
                                    $insertOrder = mysqli_query($links, "INSERT INTO `orderinf` (`orderID`, `customerID`, `total`, `orderDate`, `status`) VALUES ('', '$cusID', '$total', '$mysqltime', '1')");

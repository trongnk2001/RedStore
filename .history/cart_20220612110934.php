        ...
        <div class="small-container cart-page">
            ...
            <form action="" method="POST">
                <div class="small-container" style="padding:0px 0px">
                    <h3 style="padding: 0px 405px;background-color: #ff523b;">Thông tin giao hàng COD</h3>
                    <?php if (!empty($error)) { ?> 
            ...
            class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded"
                ...
                <div class="small-container" style="padding:0px 0px">
                    <h3 style="padding: 0px 405px;background-color: #ff523b;">Thông tin giao hàng MOMO</h3>
                    <?php if (!empty($error)) { ?> 
                    <div id="notify-msg" style="text-align: center; margin-top: 20px;font-weight: 600;">
                        <?= $error ?>
                    </div>

                         ...
                         case "submit":
                            ...
                            elseif (isset($_POST['update_checkout'])){
                                ...
                                if ($error == false && !empty($_POST['soluong'])) {
                                    ...
                                    $insertOrder = mysqli_query($links, "INSERT INTO orderinf (orderID, customerID, total, orderDate, status) VALUES ('', '$idcus', '$total', '$mysqltime', '1')");

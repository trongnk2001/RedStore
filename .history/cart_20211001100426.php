...
<body>
        ...
        <div class="small-container cart-page">
                        ...
                        $rerult = substr($value['img'],3);
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td> <input type="number" value="<?php echo $value['soluong'] ?>" style="width: 40px;height: 30px;padding: 5px;"></td>
            ...
            <div class="row" style="align-items: initial;">
                <div class="col-2 inf">
                        <p>Tên</p>
                        <input type="text" placeholder="Họ Tên" style="width:300px">
                        <p>Số điện thoại</p>
                        <input type="text" placeholder="Xin vui lòng điền số điện thoại của bạn" style="width:300px">
                </div>
                <div class="col-2 inf">
                    ...
                    <input  type="submit" value="Cập nhật &#8635" style="display: inline-block;background: #4CAF50;color: #fff;padding: 8px 30px;margin: 30px 0;border-radius: 30px;transition: background 0.5s;border: none;cursor: pointer;height:32px;width:131px ;">
                    <input  type="submit" value="Đặt hàng &#8594" style="display: inline-block;background: #ff523b;color: #fff;padding: 8px 30px;margin: 30px 0;border-radius: 30px;transition: background 0.5s;border: none;cursor: pointer;height:32px;width:131px ;">
                    </div>
                </div>
            </div>

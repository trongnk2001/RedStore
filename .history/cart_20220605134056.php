                         ...
                         case "submit":
                            ...
                            elseif (isset($_POST['update_checkout'])){
                                ...
                                if ($error == false && !empty($_POST['soluong'])) {
                                    ...
                                    var_dump('IDDDDDD:'.$add[0][0]);
                                    $last_id = mysqli_insert_id($links);
                                    $mysqltime = date ("Y-m-d H:i:s", $phptime);
                                    $insertOrder = mysqli_query($links, "INSERT INTO orderinf (orderID, customerID, total, orderDate, status) VALUES ('', '$add[0][0]', '$total', '$mysqltime', '1')");

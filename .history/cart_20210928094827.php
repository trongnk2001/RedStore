<?php
    ...
    if(isset($_POST['themgiohang'])){
        ...
        if($row){
            $new_Product = array(array('tensanpham' => $row['name'], 'id'=>$id, 'soluong'=>$row['quantity'], 'giasp'=>$row['price'], 
            'img'=>$row['img']));
            ...
            if(isset($_SESSION['cart'])){
                ...
                foreach($_SESSION['cart'] as $cart_item){
                    if($cart_item['id']==$id){
                        ...
                        $product [] = array('tensanpham' => $cart_item['name'], 'id'=>$cart_item['id'], 'soluong'=>$cart_item['soluong'], 'giasp'=>$cart_item['price'], 
                        'img'=>$cart_item['img']);
                    }
                }
            }

<?php
    ...
    if(isset($_POST['themgiohang'])){
        ...
        // if($row){
        //     $new_Product = array(array('tensanpham' => $row[2], 'id'=>$id, 'soluong'=>$sl, 'giasp'=>$row[10], 
        //     'img'=>$row[3]));
        ...
        //             if($cart_item['id']==$id){
        //                 $clone = clone $new_Product();
        //                 $product[] = array('tensanpham' => $cart_item['name'], 'id'=>$cart_item['id'], 'soluong' =>$clone('soluong')+$sl, 'giasp'=>$cart_item['price'], 
        //                 'img'=>$cart_item['img']);
        //                 $found = true;
        //             }
        //             else{

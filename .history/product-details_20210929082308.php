...
<body>
        ...
        <div class="small-container single-product">
            <div class="row">
                ...
                <div class="col-2">
                    <form method="POST" action="cart.php?productID=<?php echo $row[0]?>" >
                        <p>Trang chủ / Áo</p>
                        ...
                        <input class="sl" type="number" value ="1" name="sl[<?php echo$row[0]?>]" style="display:inline-block">

                        <input class="themhang" type="submit" name="themgiohang" value="Thêm vào giỏ hàng" style="width:auto">

...
{
	$sql_query="DELETE FROM orderdetails WHERE id=".$_GET['delete_id'];
...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
        function edt_id(id)
        {
                window.location.href='edit-customer.php?edit_id='+id;
        }
        function delete_id(id)
        {
            if(confirm('Bạn có chắc chắn xoá sản phẩm này ?'))
            {
                window.location.href='orderdetails.php?delete_id='+id;
            }
        }
</script>
  </head>
            ...
            <div class="left_col scroll-view">
                ...
                <div class="menu_section">
                    ...
                    <li><a><i class="fa fa-home"></i> Trang chủ <span class="fa fa-chevron-down"></span></a>
                        ...
                        <li><a href="admin.php">Trang chính</a></li>
                        </ul>
                    </li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      $sql_query="SELECT * FROM orderdetails";
	            ...
	            ?>
                    <tr>
                      <th colspan="8" style="text-align:center"><button type="submit" class="btn btn-success" name="btn-add"><a href="add-typepro.php" style="color:#fff">THÊM MỚI</a></button></th>
                    </tr>
                    </table>
